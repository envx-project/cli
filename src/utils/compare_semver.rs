...
mod tests {
    ...
    fn test_pre_release_versions() {
        ...
        assert_eq!(
            compare_semver("29.1.8-rc.8", "29.1.8-rc.9"),
            Ordering::Less
        );
    }
    ...
    fn test_numeric_pre_release_alpha() {
        ...
        assert_eq!(
            compare_semver("1.0-alpha", "1.0.0-alpha.1"),
            Ordering::Less
        );
    }
    ...
    fn test_build_metadata_ignored() {
        ...
        assert_eq!(
            compare_semver("16.3.1+exp.data", "16.3.1"),
            Ordering::Equal
        );
        assert_eq!(
    ...
    fn test_alternating_build_metadata() {
        assert_eq!(
            compare_semver("11.4.3", "11.4.3+meta.789"),
            Ordering::Equal
        );
        assert_eq!(
    ...
    fn test_precedence_ordering() {
        ...
        assert_eq!(
            compare_semver("1.0.0-beta", "1.0.0-beta.2"),
            Ordering::Less
        );
        assert_eq!(
